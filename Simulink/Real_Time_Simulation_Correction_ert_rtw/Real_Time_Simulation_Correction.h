 ...
 *
 * File: Real_Time_Simulation_Correction.h
 *
...
#ifndef RTW_HEADER_Real_Time_Simulation_Correction_h_
#define RTW_HEADER_Real_Time_Simulation_Correction_h_
#include <math.h>
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef Real_Time_Simulation_Correction_COMMON_INCLUDES_
# define Real_Time_Simulation_Correction_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                    /* Real_Time_Simulation_Correction_COMMON_INCLUDES_ */

#include "Real_Time_Simulation_Correction_types.h"
...
#define Real_Time_Simulation_Correction_M (Real_Time_Simulation_Correct_M)
...
} BlockIO_Real_Time_Simulation_Co;
...
} D_Work_Real_Time_Simulation_Cor;

/* Parameters (default storage) */
struct Parameters_Real_Time_Simulation_ {
...
struct tag_RTM_Real_Time_Simulation_Co {
...
extern Parameters_Real_Time_Simulation Real_Time_Simulation_Correcti_P;

/* Block signals (default storage) */
extern BlockIO_Real_Time_Simulation_Co Real_Time_Simulation_Correcti_B;

/* Block states (default storage) */
extern D_Work_Real_Time_Simulation_Cor Real_Time_Simulation_Corr_DWork;

/* Model entry point functions */
extern void Real_Time_Simulation_Correction_initialize(void);
extern void Real_Time_Simulation_Correction_step(void);
extern void Real_Time_Simulation_Correction_terminate(void);

/* Real-time Model object */
extern RT_MODEL_Real_Time_Simulation_C *const Real_Time_Simulation_Correct_M;
 ...
 *
 * '<Root>' : 'Real_Time_Simulation_Correction'
 * '<S1>'   : 'Real_Time_Simulation_Correction/Plant'
 * '<S2>'   : 'Real_Time_Simulation_Correction/Signal Builder'
 * '<S3>'   : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control'
 * '<S4>'   : 'Real_Time_Simulation_Correction/Plant/Compare To Constant'
 * '<S5>'   : 'Real_Time_Simulation_Correction/Plant/Gyro Calibration'
 * '<S6>'   : 'Real_Time_Simulation_Correction/Plant/cont'
 * '<S7>'   : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal PWM'
 * '<S8>'   : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal x1'
 * '<S9>'   : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Compare To Constant1'
 * '<S10>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Motor'
 * '<S11>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Motor1'
 * '<S12>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal PWM/Cal vol_max'
 * '<S13>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal PWM/Friction Compensator1'
 * '<S14>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal PWM/Friction Compensator2'
 * '<S15>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal x1/Cal gyro_offset'
 * '<S16>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal x1/Discrete Derivative (backward difference)'
 * '<S17>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal x1/Discrete Integrator (Forward Euler)'
 * '<S18>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal x1/Filter'
 * '<S19>'  : 'Real_Time_Simulation_Correction/Plant/Balance and Drive Control/Cal x1/Cal gyro_offset/Unit Delay External IC'
 * '<S20>'  : 'Real_Time_Simulation_Correction/Plant/Gyro Calibration/Speaker1'
 * '<S21>'  : 'Real_Time_Simulation_Correction/Plant/cont/conteur'
 */
#endif                       /* RTW_HEADER_Real_Time_Simulation_Correction_h_ */
